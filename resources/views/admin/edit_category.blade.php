                ...
                <form action="{{ url('/edit_category') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ $c->c_name }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300" placeholder="Enter category description">{{ $c->c_description }}</textarea>
                            @error('description')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
