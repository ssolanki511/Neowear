                            ...
                            <div class="w-full sm:w-auto">
                                <div class="relative">
                                    <select
                                        ...
                                        <option value="wearables">Active</option>
                                        <option value="audio">Inactive</option>
                                    </select>
                                </div>
                            </div>
                            <div class="w-full sm:w-auto">
                        ...
                        @foreach ($categories as $c)
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">{{ $c->c_name }}</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">{{ $c->c_description }}
                                    </p>
                                </td>
                                {{-- <td class="p-4 border-b border-slate-500 py-5">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('edit_category/' . $c->id) }}'"
                                        class="font-medium text-blue-600 hover:underline cursor-pointer">Edit</button>
                                    <button onclick="window.location.href='{{ url('remove_category/' . $c->id) }}'"
