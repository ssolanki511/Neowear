        ...
        <div id="add_product-modal" tabindex="-1"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow-sm border-2 border-gray-200">
                    ...
                    <form action="{{ route('edit_product') }}" method="post" id="add_product_form"
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="pn" value="{{ old('pn', $p->p_name) }}"
                            ...
                            <div class="md:col-span-2">
                                    ...
                                    <div class="flex">
                                        <div class="w-1/4">
                                            ...
                                            <input class="w-3/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2"
                                                   type="number" id="size-s" name="sizes[S]" min="0"
                                                   value="{{ old('sizes.S', $sizes['S'] ?? '') }}" placeholder="e.g., 10">
                                        ...
                                        <div class="w-1/4">
                                            ...
                                            <input class="w-3/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2"
                                                   type="number" id="size-m" name="sizes[M]" min="0"
                                                   value="{{ old('sizes.M', $sizes['M'] ?? '') }}" placeholder="e.g., 25">
                                        ...
                                        <div class="w-1/4">
                                            ...
                                            <input class="w-3/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2"
                                                   type="number" id="size-l" name="sizes[L]" min="0"
                                                   value="{{ old('sizes.L', $sizes['L'] ?? '') }}" placeholder="e.g., 20">
                                        ...
                                        <div class="w-1/4">
                                            ...
                                            <input class="w-3/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2"
                                                   type="number" id="size-xl" name="sizes[XL]" min="0"
                                                   value="{{ old('sizes.XL', $sizes['XL'] ?? '') }}" placeholder="e.g., 12">
                            ...
                            <div>
                                ...
                                <input type="number" name="price" value="{{ old('price', $p->p_price) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="₹">
                                @error('price')
                                    <div class="text-red-500">{{ $message }}</div>
                            ...
                            <div>
                                ...
                                <input type="number" name="p_offer" value="{{ old('p_offer', $p->p_offer) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Offer">
                                @error('p_offer')
                                    <div class="text-red-500">{{ $message }}</div>
                                ...
                                <select id="category" name="options" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full py-2.5 text-start px-2">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->c_name }}"
                                            {{ old('options', $p->p_category) == $category->c_name ? 'selected' : '' }}>
                                            {{ $category->c_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="img_file" name="img_file" type="file">
                                @error('img_file')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <label for="product_dis" class="block mb-2 text-sm font-medium text-gray-900">Product
                                    Description</label>
                                <textarea id="product_dis" name="product_dis" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300"
                                    placeholder="Write product description here">{{ old('product_dis', $p->p_description) }}</textarea>
                                @error('product_dis')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
