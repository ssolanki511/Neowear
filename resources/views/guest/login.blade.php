...
<head>
    ...
    <style>
        ...
        .form-container .forgot-field{
            margin-top: 11px;
        }
        .form-container .forgot-field a{
            text-decoration: underline;
            font-family: 'Helvetica Mow Text',sans-serif;
            font-size: 14px;
            color: black;
        }
        .form-container .forgot-field a:hover{
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="signup-heading">
                <h1>Enter The World of Refined Fashion.</h1>
            </div>
            <div class="form-container">
                <form action="{{ url('/signInSubmit') }}" method="post">
                    @csrf
                    <h3>Sign in</h3>
